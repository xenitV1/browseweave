...
BrowseWeave `0.1.0-beta.4` is a volunteer-maintained systemd-based Linux developer preview. Support is best-effort and has no response-time guarantee.
...
4. Run `npx browseweave@0.1.0-beta.4 doctor` and keep only non-sensitive metadata.
