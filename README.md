...
```bash
npm install --global browseweave@0.1.0-beta.7
...
After a global install, any pinned `npx browseweave@0.1.0-beta.7 ...` example
...
npx browseweave@0.1.0-beta.7 setup --browser chrome --browser-path /absolute/path/to/chrome --client codex
npx browseweave@0.1.0-beta.7 setup --browser chrome --new-profile --client codex
...
```bash
npx browseweave@0.1.0-beta.7 mcp-config generic
```
...
```bash
npx browseweave@0.1.0-beta.7 mcp-add opencode --opencode-v1
npx browseweave@0.1.0-beta.7 mcp-add opencode --opencode-v2
```
...
```bash
npx browseweave@0.1.0-beta.7 doctor
npx browseweave@0.1.0-beta.7 extension-path chrome
npx browseweave@0.1.0-beta.7 extension-path zen
```
...
```bash
npx browseweave@0.1.0-beta.7 local-uninstall
```
