...
```bash
npm install --global browseweave@0.1.0-beta.17
...
After a global install, any pinned `npx browseweave@0.1.0-beta.17 ...` example
...
```bash
npx browseweave@0.1.0-beta.17 setup --browser chrome --client codex
```

Other explicit combinations are:

```bash
npx browseweave@0.1.0-beta.17 setup --browser zen --client claude-code --client cursor
npx browseweave@0.1.0-beta.17 setup --browser chrome --browser-path /absolute/path/to/chrome --client codex
npx browseweave@0.1.0-beta.17 setup --browser chrome --new-profile --client codex
npx browseweave@0.1.0-beta.17 setup --browser chrome --client opencode --opencode-v2
```
...
```bash
npx browseweave@0.1.0-beta.17 mcp-config generic
```
...
```bash
npx browseweave@0.1.0-beta.17 mcp-add opencode --opencode-v1
npx browseweave@0.1.0-beta.17 mcp-add opencode --opencode-v2
```
...
```bash
npx browseweave@0.1.0-beta.17 local-install
```
...
```bash
npx browseweave@0.1.0-beta.17 doctor
npx browseweave@0.1.0-beta.17 extension-path chrome
npx browseweave@0.1.0-beta.17 extension-path zen
```
...
```bash
npx browseweave@0.1.0-beta.17 local-uninstall
```
